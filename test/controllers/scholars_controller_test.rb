...
class ScholarsControllerTest < ActionController::TestCase
  ...
  test "should create scholar" do
    assert_difference('Scholar.count') do
      post :create, scholar: { department: @scholar.department, firstname: @scholar.firstname, lastname: @scholar.lastname }
    end
  ...
  test "should update scholar" do
    patch :update, id: @scholar, scholar: { department: @scholar.department, firstname: @scholar.firstname, lastname: @scholar.lastname }
    assert_redirected_to scholar_path(assigns(:scholar))
  end
